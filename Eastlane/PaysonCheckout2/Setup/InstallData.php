...
*/
        ...
        $status->setData(
            [
            'status' => \Eastlane\PaysonCheckout2\Model\Payment\CreateOrder::STATE_PAYSON_PROCESSING,
            'label' => 'Payson Processing'
            ]
        )->save();
        $status->assignState(\Eastlane\PaysonCheckout2\Model\Payment\CreateOrder::STATE_PAYSON_PROCESSING, false, true);
    }
}
