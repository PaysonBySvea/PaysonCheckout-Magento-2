...
*/
    ...
    public function checkoutInit(Merchant $merchant, PayData $payData, Gui $gui = null, Customer $customer = null, $description = '')
    {
    ...
    public static function create($data)
    {
        ...
        $checkout->checkoutInit(Merchant::create($data->merchant), PayData::create($data->order), Gui::create($data->gui), Customer::create($data->customer));
