...
use Eastlane\PaysonCheckout2\Model\Api\PaysonApiException;
...
*/
    ...
    */
    ...
    public function orderItemInit($name, $unitPrice, $quantity, $taxRate, $reference, $type=self::PHYSICAL, $totalPriceExcludingTax, $totalPriceIncludingTax, $totalTaxAmount, $discountRate, $ean = null, $uri=null, $imageUri=null)
    {
    ...
    public static function create($data)
    {
        ...
        $item = $orderItemObject->orderItemInit($data->name, $data->unitPrice, $data->quantity, $data->taxRate, $data->reference, $data->type, isset($data->totalPriceExcludingTax)? $data->totalPriceExcludingTax:null, isset($data->totalPriceIncludingTax)? $data->totalPriceIncludingTax:null, isset($data->totalTaxAmount)? $data->totalTaxAmount:null, isset($data->discountRate)?$data->discountRate:null, isset($data->ean)?$data->ean:null, isset($data->uri)?$data->uri:null, isset($data->imageUri)?$data->imageUri:null);
