...
class CancelOrder
{
    ...
    public function cancelOrder($message, $quoteId)
    {
        try {
            ...
            if (($order->getPayment()->getMethod() == \Eastlane\PaysonCheckout2\Model\Paysoncheckout2ConfigProvider::CHECKOUT_CODE) && ($order->getState() === \Magento\Sales\Model\Order::STATE_CANCELED || $order->getState() === \Magento\Sales\Model\Order::STATE_PENDING_PAYMENT)) {
